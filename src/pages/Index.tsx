...
const landmarks = [
  ...
  { id: 5,  icon: '🛤',  name: 'Перевал Чике-Таман',      x: 80.8, y: 70.0, detail: 'Чике-Таман — знаменитый перевал на Чуйском тракте (1295 м). Древняя караванная тропа, где каждый путник оставлял ленту на священном дереве, прося у гор безопасной дороги.' },
  { id: 6,  icon: '🏕',  name: 'Долина реки Чулышман',    x: 62.2, y: 37.7, detail: 'Долина Чулышман — величественный каньон с отвесными стенами и водопадами. Здесь находятся каменные грибы и древние писаницы. Место силы шаманов, где, по преданиям, не работают компасы.' },
  ...
  { id: 11, icon: '🏙',  name: 'Горно-Алтайск',            x: 28.5, y: 20.0, detail: 'Горно-Алтайск — столица Республики Алтай. Отправная точка большинства маршрутов. Здесь находится Национальный музей, где хранится мумия «Алтайской принцессы» и богатейшая коллекция артефактов древних культур Алтая.' },
];
            ...
            >
              ...
              {landmarks.map((lm) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="text-2xl transition-all duration-200 group-hover:scale-125"
                      style={{
