...
const MAP_IMG = 'https://cdn.poehali.dev/projects/709f8aa2-b778-4092-a2a7-3f93727724e2/bucket/7c292c87-0d75-4c32-944c-e3ae09617cad.png';
...
const landmarks = [
  ...
  { id: 3,  icon: '🗿❓', name: 'Плато Укок',                         x: 58.7, y: 78.7, detail: 'Плато Укок — «зона покоя» на стыке границ России, Монголии, Китая и Казахстана. Место древних захоронений (курганов) и петроглифов. В 1993 году здесь была найдена мумия «Алтайской принцессы». Плато считается одним из самых сильных мест силы на Алтае.' },
  ...
  { id: 5,  icon: '🕯️🛤️', name: 'Перевал Чике-Таман',               x: 80.8, y: 70.0, detail: 'Чике-Таман — знаменитый перевал на Чуйском тракте (1295 м). Древняя караванная тропа, где каждый путник оставлял ленту на священном дереве, прося у гор безопасной дороги.' },
  ...
  { id: 7,  icon: '💎👁️', name: 'Гейзеровое озеро',                  x: 48.8, y: 67.3, detail: 'Гейзеровое (Голубое) озеро — небольшое озеро с бирюзовой водой, на дне которого бьют термальные источники, рисующие меняющиеся узоры из голубой глины. Уникальное место, не замерзающее зимой.' },
  ...
  { id: 11, icon: '🎩🏙️', name: 'Горно-Алтайск',                     x: 28.5, y: 20.0, detail: 'Горно-Алтайск — столица Республики Алтай. Отправная точка большинства маршрутов. Здесь находится Национальный музей, где хранится мумия «Алтайской принцессы» и богатейшая коллекция артефактов древних культур Алтая.' },
  { id: 12, icon: '👽🔴', name: 'Марс (Кызыл-Чин)',                  x: 75.0, y: 73.0, detail: 'Урочище Кызыл-Чин — «Алтайский Марс». Разноцветные глинистые холмы красных, оранжевых и фиолетовых оттенков напоминают поверхность другой планеты. Один из самых фотогеничных пейзажей Алтая.' },
  { id: 13, icon: '🦌🌀', name: 'Чуйские меандры',                   x: 55.5, y: 63.0, detail: 'Чуйские меандры — живописные излучины реки Чуи, видные с высоты перевала Кату-Ярык. Бирюзовая лента реки, петляющая среди гор, — одна из самых узнаваемых панорам Алтая.' },
  { id: 14, icon: '🗝️🛣️', name: 'Чуйский тракт (смотровая)',        x: 65.0, y: 55.0, detail: 'Чуйский тракт — легендарная дорога, признанная одной из красивейших в мире. Смотровые площадки открывают виды на ущелья, реки и горные хребты, которые невозможно забыть.' },
  { id: 15, icon: '💀🏺', name: 'Пазырыкские курганы',               x: 38.0, y: 71.0, detail: 'Пазырыкские курганы — захоронения скифской эпохи V–III вв. до н.э. В вечной мерзлоте сохранились ткани, татуированные мумии, лошади в полном снаряжении. Один из важнейших археологических памятников мира.' },
  { id: 16, icon: '🦅🔴', name: 'Красные ворота',                    x: 70.0, y: 68.0, detail: 'Красные ворота — живописное ущелье, прорезанное рекой Чибитка в красноватых горных породах. Узкий проход с отвесными стенами яркого цвета — природные «врата» в глубь Алтая.' },
  { id: 17, icon: '🍄🪵', name: 'Каменные грибы Аккурум',            x: 64.5, y: 42.0, detail: 'Каменные грибы — причудливые скальные останцы с широкими «шляпками» из твёрдого камня. Добраться до них можно только пешком по горной тропе вдоль Чулышмана. Каждый «гриб» уникален по форме.' },
  { id: 18, icon: '🥾🏔️', name: 'Шавлинские озёра',                 x: 72.0, y: 65.0, detail: 'Шавлинские озёра — высокогорные озёра с кристально чистой бирюзовой водой у подножия пика Красавица. Одно из самых труднодоступных и красивых мест Алтая — добраться можно только пешком или на лошадях.' },
  { id: 19, icon: '🐆❄️', name: 'Ледник Актру',                      x: 78.0, y: 66.0, detail: 'Ледник Актру — крупнейший ледник Северо-Чуйского хребта. Место тренировок альпинистов и популярная цель треккинга. Отсюда открывается вид на белоснежные вершины, теряющиеся в облаках.' },
  { id: 20, icon: '🦅🌄', name: 'Перевал Кату-Ярык',                 x: 60.0, y: 38.0, detail: 'Перевал Кату-Ярык — крутой серпантин с перепадом высот 800 м, открывающий захватывающий вид на долину Чулышмана. Один из самых впечатляющих горных перевалов Алтая.' },
  { id: 21, icon: '🌲💠', name: 'Мультинские озёра',                 x: 35.0, y: 62.0, detail: 'Мультинские озёра — система горных озёр в Катунском заповеднике, соединённых бурными порогами и водопадами. Нетронутая природа, кедровая тайга и изумрудная вода делают это место сказочным.' },
  { id: 22, icon: '🔦🦴', name: 'Денисова пещера',                   x: 21.0, y: 21.0, detail: 'Денисова пещера — одно из важнейших мест в истории человечества. Здесь обнаружены останки денисовского человека — ранее неизвестного вида людей. Возраст артефактов достигает 300 000 лет.' },
  { id: 23, icon: '🌙💧', name: 'Озеро Ая',                          x: 25.0, y: 28.0, detail: 'Озеро Ая — «Лунное озеро». Одно из немногих тёплых озёр Алтая, прогревающееся летом до +22°C. Окружено скалами и хвойным лесом. Популярное место отдыха у туристов, приезжающих на Алтай впервые.' },
  { id: 24, icon: '🕯️⛪', name: 'Остров Патмос',                     x: 30.0, y: 24.0, detail: 'Остров Патмос — скала посреди реки Катунь в Чемале, на которой стоит деревянный православный храм Иоанна Богослова. Добраться можно по подвесному мосту. Место силы и духовного притяжения для многих паломников.' },
  { id: 25, icon: '🦇🕸️', name: 'Тавдинские пещеры',                x: 32.0, y: 22.5, detail: 'Тавдинские пещеры — система из более чем 30 карстовых пещер с древними наскальными рисунками и следами стоянок первобытных людей. Наиболее известна Тавдинская арка — сквозная пещера над рекой Катунь.' },
  { id: 26, icon: '📜🏔️', name: 'Семинский перевал',                 x: 82.0, y: 58.0, detail: 'Семинский перевал (1717 м) — один из крупнейших перевалов Чуйского тракта. Здесь растут вековые кедры, а с вершины открывается панорама на несколько горных хребтов. Здесь расположена олимпийская тренировочная база.' },
  { id: 27, icon: '🌲🌀', name: 'Озеро Манжерок',                    x: 33.0, y: 24.5, detail: 'Озеро Манжерок — живописное озеро у подножия горы Малая Синюха. Благодаря тёплой воде и близости к Горно-Алтайску — один из самых популярных курортов Алтая. Здесь проходили съёмки фильмов и фестивали.' },
  { id: 28, icon: '🌫️🏔️', name: 'Белый Бом',                        x: 70.0, y: 69.5, detail: 'Белый Бом — отвесная белая скала над рекой Чуей. Одно из самых узнаваемых мест Чуйского тракта. По легенде, здесь живёт дух горы, охраняющий путников от несчастий в дороге.' },
  { id: 29, icon: '📖💠', name: 'Долина Ярлу',                       x: 40.0, y: 68.0, detail: 'Долина Ярлу — место, воспетое Николаем Рерихом. Здесь стоит знаменитый «Камень Рериха» — огромный валун, ставший символом духовных исканий. Художник считал эту долину вратами в высший мир.' },
  { id: 30, icon: '🔮💧', name: 'Кучерлинское озеро',                x: 38.0, y: 65.0, detail: 'Кучерлинское озеро — высокогорное озеро в Катунском заповеднике с удивительно насыщенным бирюзовым цветом воды. Добраться можно пешком или на лошадях через живописные перевалы.' },
  { id: 31, icon: '💧🔥', name: 'Источник Аржан-Бугузун',            x: 75.0, y: 78.0, detail: 'Аржан-Бугузун — тёплые минеральные источники в высокогорной степи. «Аржан» по-алтайски означает «священная вода». Местные жители приходят сюда лечиться и медитировать у воды.' },
  { id: 32, icon: '🌲💧', name: 'Водопад Корбу',                     x: 60.0, y: 32.5, detail: 'Водопад Корбу — один из крупнейших водопадов Алтая (12 м), впадающий в Телецкое озеро. Добраться можно только по воде на катере. Мощный поток воды и дикая природа вокруг создают незабываемое впечатление.' },
  { id: 33, icon: '🗿⚔️', name: 'Каменные изваяния Кезер',           x: 70.5, y: 72.5, detail: 'Каменные изваяния Кезер — древнетюркские балбалы, изображающие воинов степи. Установлены у погребальных курганов и смотрят на восток. Молчаливые стражи Алтая, хранящие память о кочевых империях.' },
  { id: 34, icon: '⚠️🛤️', name: 'Бомы Чуйского тракта',             x: 77.0, y: 66.5, detail: 'Бомы — опасные участки Чуйского тракта, где дорога проходит по узким карнизам над бездонными пропастями. Захватывающие дух виды и адреналин — неотъемлемая часть путешествия по легендарному тракту.' },
];
