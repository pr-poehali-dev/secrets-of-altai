...
const landmarks = [
  ...
  { id: 10, icon: '🔵', name: 'Каракольские озёра',                x: 45.9, y: 33.1, detail: 'Каракольские озёра — семь высокогорных озёр, расположенных каскадом на разной высоте. Каждое имеет свой цвет и характер. Место паломничества любителей нетронутой природы Алтая.' },
  ...
  { id: 14, icon: '🛣️', name: 'Чуйский тракт (смотровая)',        x: 65.0, y: 55.0, detail: 'Чуйский тракт — легендарная дорога, признанная одной из красивейших в мире. Смотровые площадки открывают виды на ущелья, реки и горные хребты, которые невозможно забыть.' },
  ...
  { id: 24, icon: '⛪', name: 'Остров Патмос',                     x: 30.0, y: 24.0, detail: 'Остров Патмос — скала посреди реки Катунь в Чемале, на которой стоит деревянный православный храм Иоанна Богослова. Добраться можно по подвесному мосту. Место силы и духовного притяжения для многих паломников.' },
  ...
  { id: 28, icon: '🏔️', name: 'Белый Бом',                        x: 70.0, y: 69.5, detail: 'Белый Бом — отвесная белая скала над рекой Чуей. Одно из самых узнаваемых мест Чуйского тракта. По легенде, здесь живёт дух горы, охраняющий путников от несчастий в дороге.' },
  ...
  { id: 34, icon: '🛤️', name: 'Бомы Чуйского тракта',             x: 77.0, y: 66.5, detail: 'Бомы — опасные участки Чуйского тракта, где дорога проходит по узким карнизам над бездонными пропастями. Захватывающие дух виды и адреналин — неотъемлемая часть путешествия по легендарному тракту.' },
];
