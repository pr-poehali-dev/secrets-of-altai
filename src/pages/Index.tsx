...
const landmarks = [
  ...
  { id: 6,  name: 'Долина реки Чулышман',       x: 59.9, y: 48.0, detail: 'Долина Чулышман — величественный каньон с отвесными стенами и водопадами. Здесь находятся каменные грибы и древние писаницы. Место силы шаманов, где, по преданиям, не работают компасы.' },
  ...
  { id: 17, name: 'Каменные грибы Аккурум',    x: 62.7, y: 43.9, detail: 'Каменные грибы — причудливые скальные останцы с широкими «шляпками» из твёрдого камня. Добраться до них можно только пешком по горной тропе вдоль Чулышмана. Каждый «гриб» уникален по форме.' },
  ...
  { id: 23, name: 'Озеро Ая',                  x: 63.0, y: 5.0,  detail: 'Озеро Ая — «Лунное озеро». Одно из немногих тёплых озёр Алтая, прогревающееся летом до +22°C. Окружено скалами и хвойным лесом. Популярное место отдыха у туристов, приезжающих на Алтай впервые.' },
  { id: 24, name: 'Остров Патмос',             x: 57.9, y: 5.5,  detail: 'Остров Патмос — скала посреди реки Катунь в Чемале, на которой стоит деревянный православный храм Иоанна Богослова. Добраться можно по подвесному мосту. Место силы и духовного притяжения для многих паломников.' },
  { id: 25, name: 'Тавдинские пещеры',         x: 52.0, y: 5.5,  detail: 'Тавдинские пещеры — система из более чем 30 карстовых пещер с древними наскальными рисунками и следами стоянок первобытных людей. Наиболее известна Тавдинская арка — сквозная пещера над рекой Катунь.' },
  ...
  { id: 27, name: 'Озеро Манжерок',            x: 48.0, y: 6.2,  detail: 'Озеро Манжерок — живописное озеро у подножия горы Малая Синюха. Благодаря тёплой воде и близости к Горно-Алтайску — один из самых популярных курортов Алтая. Здесь проходили съёмки фильмов и фестивали.' },
