...
const landmarks = [
  {
    id: 1, icon: '⛰️', name: 'Гора Белуха', x: 75, y: 27,
  ...
  {
    id: 2, icon: '🌊', name: 'Телецкое озеро', x: 31, y: 63,
  ...
  {
    id: 3, icon: '🏕️', name: 'Плато Укок', x: 92, y: 73,
  ...
  {
    id: 4, icon: '🌀', name: 'Река Катунь', x: 21, y: 47,
  ...
  {
    id: 6, icon: '🏞️', name: 'Долина реки Чулышман', x: 42, y: 80,
  ...
  {
    id: 7, icon: '💧', name: 'Гейзеровое озеро', x: 27, y: 73,
  ...
  {
    id: 8, icon: '📜', name: 'Петроглифы Калбак-Таш', x: 17, y: 60,
  ...
  {
    id: 9, icon: '💦', name: 'Водопад Учар', x: 58, y: 87,
  ...
  {
    id: 10, icon: '🏔️', name: 'Каракольские озёра', x: 67, y: 53,
